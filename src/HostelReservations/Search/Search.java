...
public class Search {
	...
	public void getInventory(String hostel_name) {
		// TODO Auto-generated method stub
	...
	public void SearchInventory(String hostel_name, String city, Date start_date, Date end_date) {
		// TODO Auto-generated method stub
	...
	public void SearchInventory(String hostel_name, String city, Date start_date, Date end_date, int number_of_beds) 
	{
		float bed_price = 0;
		// TODO Auto-generated method stub
		String room_number = "";
	...
	public static int getHostelID(String hostel_name)
	{
		int hostel_id = 0;
		String sql_statement = "SELECT Hostel_ID FROM hostelsdb.hostels WHERE Hostel_Name = '" + hostel_name + "';";
		try {
			CachedRowSet rs = Utils.executeQuery(sql_statement);
			while(rs.next())
			{
